...
<body>
  ...
  <form action="<?php echo base_url('AdminLoginbo/login'); ?>" method="post" class="login-container" >
    <p align="center"><?php echo $this->session->flashdata('Error'); ?></p>
    <p><input type="text" name="user" placeholder="Enter Username or Email" required></p>
